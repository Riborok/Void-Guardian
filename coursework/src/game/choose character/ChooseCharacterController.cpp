...
#include "../../../include/game/choose character/ChooseCharacterController.hpp"
...
size_t& ChooseCharacterController::getSpriteIndex() const {
    return _game_context->player_progress.player_inventory.character_num;
}

void ChooseCharacterController::setPositions() {
...
void ChooseCharacterController::createButtons(const ButtonColors& button_colors) {
...
void ChooseCharacterController::draw(const int delta_time) {
...
void ChooseCharacterController::handleKeyPressed(const sf::Keyboard::Key key) {
    switch (key) {
...
void ChooseCharacterController::handleEvents() {
    auto& window = _game_context->window;
    sf::Event event;
...
ChooseCharacterController::ChooseCharacterController(GameContext& game_context, AnimatedSprites&& sprites,
...
void ChooseCharacterController::start(GameState& game_state) {
