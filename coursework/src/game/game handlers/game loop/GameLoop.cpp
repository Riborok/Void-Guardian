#include "../../../../include/game/game handlers/game loop/GameLoop.hpp"
...
GameLoop::GameLoop(SetNewWindowSize &&set_new_window_size, sf::RenderWindow& window,
    ...
    _event_handler(window, _game_loop_state, std::move(set_new_window_size), fullscreen_toggler, pause_subset.cursor,
