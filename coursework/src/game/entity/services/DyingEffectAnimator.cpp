...
DyingEffectAnimator::DyingEffectAnimator(ElementCreator& element_creator, AnimationAttacher &animation_attacher):
    _element_creator(&element_creator), _animation_attacher(&animation_attacher) {}
...
void DyingEffectAnimator::createAnimation(const FightingEntity &entity) const {
    ...
    _animation_attacher->addAnimation(_element_creator->create({
        polygon.getPoints()[0],
        polygon.getRotation(),
