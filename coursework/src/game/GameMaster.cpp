...
void GameMaster::createExecutors() {
    ...
    auto *player_executor = new PlayerExecutor(*_window, _input_handler, _collision_manager,
    ...
    auto *bullet_executor = new BulletExecutor(_collision_manager, _entity_maps.bullet_map,
        {_entity_maps, _element_creator, *animation_executor, _game_field.quadtree_el});
...
void GameMaster::addPlayer() {
    _entity_maps.player_map.insert(_player);
