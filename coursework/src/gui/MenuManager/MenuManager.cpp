...
MenuManager::MenuManager(GameSetup &game_setup, MenuManagerInfo &&menu_manager_info,
    ...
    createMenu(colors.button_colors);
    setButtonPos();
}
...
void MenuManager::createMenu(const ButtonColors& button_colors) {
    ...
    _buttons.addButtonWidthOriginCenter("SETTINGS", [this]{_game_setup->gui_managers.settings_manager.startSettings();}, button_colors);
