...
#include "../../include/gui/SettingsManager.hpp"
...
SettingsManager::SettingsManager(GameContext& game_context, SettingsManagerInfo&& settings_manager_info,
        ...
        _settings_manager_info(std::move(settings_manager_info)), _buttons(_settings_manager_info.font),
        _background_color(setting_colors.menu_colors.background_color), _pressed_color(setting_colors.pressed_color) {
    createSettings(setting_colors.menu_colors.button_colors);
    setTextPos();
}
