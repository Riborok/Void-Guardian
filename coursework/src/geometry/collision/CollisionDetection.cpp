...
namespace CollisionDetection {
    namespace InnerLogic {
        ...
        void getProjection(Polygon &polygon, const sf::Vector2f &axis, Projection &result) {
        ...
        void getExtendedProjection(Polygon &polygon, const sf::Vector2f &axis, const bool calculate_mid_point,
        ...
        bool areProjectionsOverlapping(const std::vector<Axis> &axes, Polygon &polygon1, Polygon &polygon2) {
        ...
        bool isSmallestOverlapAxisFound(const std::vector<Axis> &axes, const bool is_axes1,
                Polygon &polygon1, Polygon &polygon2, CollisionResultHelper &collision_result_help) {
            for (const auto &axis : axes) {
                Projection projection1;
                getProjection(polygon1, axis, projection1);
                Projection projection2;
        ...
        void findClosestVertex(Polygon &polygon1, Polygon &polygon2, const Axis &axis,
    ...
    bool hasCollision(Polygon &polygon1, Polygon &polygon2,
