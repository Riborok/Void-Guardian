...
public:
    ...
    void addButton(const std::string& label, std::function<void()> &&on_click_callback, const ButtonColors& button_colors);
    void addButtonWidthOriginCenter(const std::string& label, std::function<void()> &&on_click_callback, const ButtonColors& button_colors);
